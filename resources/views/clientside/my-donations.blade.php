...
@section('main-container')
    ...
    <div class="breadcrumb-bg w3l-inner-page-breadcrumb py-5">
      <div class="container pt-lg-5 pt-md-3 p-lg-4 pb-md-3 my-lg-3">
        <h2 class="title pt-5">My Donations</h2>
        <ul class="breadcrumbs-custom-path mt-3 text-center">
          <li><a href="/">Home</a></li>
          <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true"></span> My Donations </li>
        </ul>
      </div>
    </div>
  <!--//breadcrumb-bg-->
                            ...
                            <tbody>
                              @foreach($donations as $donation)
                                <tr>
                                    ...
                                    @endif
                                    <td><a class="btn btn-sm btn-primary" href="{{url('/delete-donation/'.$donation->id)}}">Delete</a></td>
                                </tr>
                                @endforeach
                            </tbody>
</table>
